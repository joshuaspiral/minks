...
The primary limitation we encountered was the inherent sparsity of the graph and the subjective nature of \enquote{missing} links. Our edge holdout evaluation assumes that randomly removed edges are the only valid \enquote{correct} predictions. In reality, the algorithm often predicts highly meaningful lateral connections that the user simply hadn't thought to create yet, which the strict evaluation metrics unfairly penalize as \enquote{incorrect}.

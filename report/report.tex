...
\begin{enumerate}
    \item \textbf{Obtain Datasets:} Double-click to download the vaults: \textcolor{blue}{\textattachfile[color=0 0 1]{vaults.zip}{vaults.zip}}. Extract the folder so that the \texttt{vaults/} directory (containing \texttt{vault\_a} and \texttt{vault\_b}) is in the same directory as the \texttt{src/} folder.

...
\begin{enumerate}
    \item \textbf{Obtain Datasets:} \textattachfile{vaults.tar.gz}{Download the vaults here: vaults.tar.gz}. Extract the folder so that the \texttt{vaults/} directory (containing \texttt{vault\_a} and \texttt{vault\_b}) is in the same directory as the \texttt{src/} folder.

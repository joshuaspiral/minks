...
\begin{itemize}
    \item \textbf{Vault A (Tuning Set):} The open-source digital garden of Jacky Zhao (\url{https://jzhao.xyz}). This vault contains over 700 notes spanning computer science, philosophy, and other topics. It provides a denser and more diverse graph, allowing us to test our algorithm's out-of-domain generalizability. We utilized the raw \texttt{.md} plaintext and internal WikiLinks from this set.
